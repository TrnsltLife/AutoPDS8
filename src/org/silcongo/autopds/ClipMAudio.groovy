...
class ClipMAudio extends ClipAudio
{
	//AEFF_MAUDIO_A_TRACK/AEFF_MAUDIO_B_TRACK:
	//<CLIP ID="0" IDREF="84" NAME="" START="0" STOP="581668335" SCENESTART="0" SCENESTOP="0" MEDIASTART="0" MEDIASTOP="0" MUTE="TRUE" STRETCHMODE="">

	def clipMVideo
	
	public ClipMAudio(uid, mediaObj, startTime, dur=-1)
	{
		super(uid, mediaObj, startTime, dur)
	}
...
<PARAM NAME="MAUDIO_MUTE" VALUETYPE="BOOL" VALUE="${mute.B()}"/>
...
/*
<CLIP ID="0" IDREF="95" NAME="" START="0" STOP="50050050" SCENESTART="0" SCENESTOP="0" MEDIASTART="0" MEDIASTOP="5006005" MUTE="FALSE" STRETCHMODE="" PANOVISIONMODE="0">
<CLIP_EXTRA_DATA ID="0">
<PARAM NAME="AUDIO_NOICE_REDUCE_STRENGTH" VALUETYPE="FLOAT" VALUE="0.000000"/>
<PARAM NAME="AUDIO_NOICE_REDUCE_TYPE" VALUETYPE="INT" VALUE="0"/>
<PARAM NAME="AUDIO_REVERSE_FLAG" VALUETYPE="BOOL" VALUE="FALSE"/>
<PARAM NAME="MAUDIO_VALID" VALUETYPE="BOOL" VALUE="TRUE"/>
<PARAM NAME="MAUDIO_MUTE" VALUETYPE="BOOL" VALUE="TRUE"/>
<CLIP_EXTRA_DATA_MAGICEFFECT ID="0"/>
</CLIP_EXTRA_DATA>
<EFFECT ID="0" NAME="" GUID="CES_PLUGIN.DLL\DSP_AU_VolumeAdj" START="0" STOP="0" MUTE="FALSE"/>
<EFFECT ID="1" NAME="" GUID="CES_PLUGIN.DLL\DSP_AU_VolumeAdj" START="0" STOP="0" MUTE="FALSE">
<PARAM NAME="CROSSFADEIN" VALUETYPE="INT" VALUE="">
<LINEAR TIME="0" VALUE="0"/>
<LINEAR TIME="0" VALUE="1"/>
</PARAM>
</EFFECT>
<EFFECT ID="2" NAME="" GUID="CES_PLUGIN.DLL\DSP_AU_VolumeAdj" START="0" STOP="0" MUTE="FALSE">
<PARAM NAME="CROSSFADEOUT" VALUETYPE="INT" VALUE="">
<LINEAR TIME="50050050" VALUE="1"/>
<LINEAR TIME="50050050" VALUE="0"/>
</PARAM>
</EFFECT>
<EFFECT ID="3" NAME="" GUID="CES_PLUGIN.DLL\DSP_AU_VolumeAdj" START="0" STOP="0" MUTE="FALSE">
<PARAM NAME="GAIN" VALUETYPE="FLOAT" VALUE="0.000000"/>
</EFFECT>
</CLIP>
*/